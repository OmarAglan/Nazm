...
TESTS="test_arena test_unicode test_symtable test_keywords test_immediate test_rex test_lexer test_parser test_encoder test_passes test_elf64 test_cli_args"
