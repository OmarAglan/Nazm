...
static const RegEntry REG_TABLE[] = {
    ...
    { "سجل_المركم_٣٢", REG_EAX },
    { "سجل_العداد_٣٢", REG_ECX },
    { "سجل_البيانات_٣٢", REG_EDX },
    { "سجل_القاعدة_٣٢", REG_EBX },
    { "مؤشر_المكدس_٣٢", REG_ESP },
    { "مؤشر_القاعدة_٣٢", REG_EBP },
    { "فهرس_المصدر_٣٢", REG_ESI },
    { "فهرس_الوجهة_٣٢", REG_EDI },
    { "سجل_عام_٨_٣٢", REG_R8D },
    { "سجل_عام_٩_٣٢", REG_R9D },
    { "سجل_عام_١٠_٣٢", REG_R10D },
    { "سجل_عام_١١_٣٢", REG_R11D },
    { "سجل_عام_١٢_٣٢", REG_R12D },
    { "سجل_عام_١٣_٣٢", REG_R13D },
    { "سجل_عام_١٤_٣٢", REG_R14D },
    { "سجل_عام_١٥_٣٢", REG_R15D },

    { "سجل_المركم_١٦", REG_AX },
    { "سجل_العداد_١٦", REG_CX },
    { "سجل_البيانات_١٦", REG_DX },
    { "سجل_القاعدة_١٦", REG_BX },
    { "مؤشر_المكدس_١٦", REG_SP },
    { "مؤشر_القاعدة_١٦", REG_BP },
    { "فهرس_المصدر_١٦", REG_SI },
    { "فهرس_الوجهة_١٦", REG_DI },
    { "سجل_عام_٨_١٦", REG_R8W },
    { "سجل_عام_٩_١٦", REG_R9W },
    { "سجل_عام_١٠_١٦", REG_R10W },
    { "سجل_عام_١١_١٦", REG_R11W },
    { "سجل_عام_١٢_١٦", REG_R12W },
    { "سجل_عام_١٣_١٦", REG_R13W },
    { "سجل_عام_١٤_١٦", REG_R14W },
    { "سجل_عام_١٥_١٦", REG_R15W },

    { "سجل_المركم_٨", REG_AL },
    { "سجل_العداد_٨", REG_CL },
    { "سجل_البيانات_٨", REG_DL },
    { "سجل_القاعدة_٨", REG_BL },
    { "مؤشر_المكدس_٨", REG_SPL },
    { "مؤشر_القاعدة_٨", REG_BPL },
    { "فهرس_المصدر_٨", REG_SIL },
    { "فهرس_الوجهة_٨", REG_DIL },
    { "سجل_عام_٨_٨", REG_R8B },
    { "سجل_عام_٩_٨", REG_R9B },
    { "سجل_عام_١٠_٨", REG_R10B },
    { "سجل_عام_١١_٨", REG_R11B },
    { "سجل_عام_١٢_٨", REG_R12B },
    { "سجل_عام_١٣_٨", REG_R13B },
    { "سجل_عام_١٤_٨", REG_R14B },
    { "سجل_عام_١٥_٨", REG_R15B },
    ...
    { "سجل_عشري_٨", REG_XMM8 },
    { "سجل_عشري_٩", REG_XMM9 },
    { "سجل_عشري_١٠", REG_XMM10 },
    { "سجل_عشري_١١", REG_XMM11 },
    { "سجل_عشري_١٢", REG_XMM12 },
    { "سجل_عشري_١٣", REG_XMM13 },
    { "سجل_عشري_١٤", REG_XMM14 },
    { "سجل_عشري_١٥", REG_XMM15 },
    { NULL, -1 },
};
...
static const LegacyRegister LEGACY_REGISTERS[] = {
    ...
    { "سجل_عام_8", "سجل_عام_٨" },
    { "سجل_عام_9", "سجل_عام_٩" },
    { "سجل_عام_10", "سجل_عام_١٠" },
    { "سجل_عام_11", "سجل_عام_١١" },
    { "سجل_عام_12", "سجل_عام_١٢" },
    { "سجل_عام_13", "سجل_عام_١٣" },
    { "سجل_عام_14", "سجل_عام_١٤" },
